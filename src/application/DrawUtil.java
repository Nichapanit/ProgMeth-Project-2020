...
public class DrawUtil {
	...
	private static String image_path = ClassLoader.getSystemResource("item sprites.png").toString();
...
//	private static Image congratsprites = new Image(congrat_path);
	...
	public static void drawSprite(GraphicsContext gc,int x,int y,int index) {
		WritableImage img = new WritableImage(mainsprites.getPixelReader(),index*64,0,64,64);
